...
resource "ibm_iam_access_group_policy" "resourcepolicy_developer" {
  ...
  resources {
    ...
    resource      = data.terraform_remote_state.per_environment_test.outputs.resource_group_id
  }
}
...
resource "ibm_iam_access_group_policy" "developer_logging_policy" {
  ...
  resources {
    service              = "logdna"
    resource_instance_id = data.terraform_remote_state.per_environment_test.outputs.logdna_instance_id
  }
}
resource "ibm_iam_access_group_policy" "developer_monitoring_policy" {
  ...
  resources {
    ...
    resource_instance_id = data.terraform_remote_state.per_environment_test.outputs.sysdig_instance_id
  }
}
